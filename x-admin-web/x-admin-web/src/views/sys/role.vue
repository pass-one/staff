  ...
  <div>
    ...
    <el-card>
      <el-table :data="roleList" stripe style="width: 100%">
        ...
        <el-table-column prop="roleId" label="员工ID" width="280">
        </el-table-column>
        <el-table-column prop="roleName" label="员工名称" width="260">
        </el-table-column>
        <el-table-column prop="roleDesc" label="员工描述"> </el-table-column>
        <el-table-column label="操作" width="180">
          <template slot-scope="scope">
            <el-button @click="openEditUI(scope.row.roleId)" type="primary" size="mini" icon="el-icon-edit" circle></el-button>
            <el-button @click="deleteRole(scope.row)" type="danger" size="mini" icon="el-icon-delete" circle></el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
    ...
    <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible">
      <el-form :model="roleForm" ref="roleFormRef" :rules="rules">
        <el-form-item label="员工名称" prop="roleName" :label-width="formLabelWidth">
          <el-input v-model="roleForm.roleName" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="员工描述" prop="roleDesc" :label-width="formLabelWidth">
          <el-input v-model="roleForm.roleDesc" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="权限设置" prop="menuIdList" :label-width="formLabelWidth">
          <el-tree :data="menuList" :props="menuProps" node-key="menuId" ref="menuRef" show-checkbox style="width:85%" default-expand-all></el-tree>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    deleteRole(role){
       this.$confirm(`您确认删除员工 ${role.roleName}?`,  '提示', {
